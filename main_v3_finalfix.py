...
class GuidedPoseProgram_UI(GuidedPoseProgram):
    ...
    def run_program(self):
        ...
        while True:
            ...
            # --- NEW: Independent Counter for ACTUAL completions ---
            poses_completed_count = 0 
            ...
            while True:
                ...
                if time_left <= 0:
                    ...
                    # Note: We do NOT increment poses_completed_count on timeout/skip
                    self.pose_attempt_start_time = None
                    self.pose_start_time = None
                    if self.current_pose_index < len(self.poses_sequence):
            ...
            # FIX: We pass poses_completed_count instead of current_pose_index
            self.show_summary_screen(poses_completed_count, f"{mins}m {secs}s")
